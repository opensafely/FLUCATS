...
df <- read_csv("output/joined/full/input_all.csv", guess_max=10000) %>% 
  select(
    ...
    bmi_primis, 
    asthma, 
    addisons_hypoadrenalism, 
    chronic_heart_disease, 
    chronic_respiratory_disease, 
    ckd_primis_stage, 
    renal_disease, 
    ckd35_or_renal_disease, 
    ckd_os, 
    liver_disease, 
    pregnant, 
    diabetes, 
    ...
    hypertension, 
    pneumonia, 
    immunosuppression_disorder, 
    immunosuppression_chemo, 
    ...
    region, 
    imdQ5, 
    flucats_question_altered_conscious_level_162701007, 
    flucats_question_altered_conscious_level_162702000, 
    flucats_question_altered_conscious_level_162704004, 
    flucats_question_altered_conscious_level_162705003, 
    flucats_question_altered_conscious_level_268913004, 
    flucats_question_blood_pressure_163020007,  
    flucats_question_blood_pressure_163021006,
    flucats_question_blood_pressure_163025002, 
    flucats_question_blood_pressure_163026001, 
    flucats_question_blood_pressure_163027005, 
    flucats_question_blood_pressure_163028000, 
    flucats_question_blood_pressure_163029008, 
    flucats_question_blood_pressure_163030003, 
    flucats_question_blood_pressure_163031004, 
    flucats_question_blood_pressure_163032006, 
    flucats_question_blood_pressure_163036009, 
    flucats_question_blood_pressure_163037000, 
    flucats_question_blood_pressure_163053002, 
    flucats_question_blood_pressure_170581003, 
    flucats_question_blood_pressure_170582005, 
    flucats_question_blood_pressure_274283008, 
    flucats_question_blood_pressure_310357009, 
    flucats_question_severe_respiratory_distress_162892000, 
    flucats_question_respiratory_exhaustion_1023001, 
    flucats_question_respiratory_exhaustion_162889004, 
    flucats_question_respiratory_exhaustion_162896002, 
    ...
    flucats_question_respiratory_exhaustion_268927009, 
    flucats_question_who_performance_score_129072006, 
    flucats_question_who_performance_score_160680006, 
    flucats_question_who_performance_score_160684002, 
    flucats_question_who_performance_score_160685001, 
    flucats_question_heart_rate_162986007, 
    flucats_question_heart_rate_162990009, 
    flucats_question_heart_rate_162992001, 
    flucats_question_respiratory_rate_162913005, 
    flucats_question_respiratory_rate_162914004, 
    flucats_question_respiratory_rate_162915003, 
    flucats_question_respiratory_rate_162916002, 
    flucats_question_inspired_oxygen_427081008, 
    flucats_question_inspired_oxygen_698833004, 
    ...
    flucats_question_suspected_covid_1029481000000103, 
    flucats_question_suspected_covid_1240451000000106, 
    flucats_question_suspected_covid_1240511000000106, 
    flucats_question_suspected_covid_1240581000000104, 
    flucats_question_suspected_covid_1300721000000109, 
    flucats_question_suspected_covid_1300731000000106, 
    flucats_question_suspected_covid_1321301000000101, 
    flucats_question_suspected_covid_1322781000000102, 
    flucats_question_suspected_covid_1324601000000106, 
    flucats_question_suspected_covid_204351000000100, 
    flucats_question_suspected_covid_50321000237103, 
    flucats_question_suspected_covid_51631000237101, 
    flucats_question_suspected_covid_817111000000102, 
    flucats_question_suspected_covid_871553007, 
    flucats_question_suspected_covid_871555000, 
    flucats_question_suspected_covid_871556004, 
    flucats_question_suspected_covid_871557008, 
    flucats_question_suspected_covid_871558003, 
    flucats_question_suspected_covid_871559006, 
    flucats_question_suspected_covid_871560001, 
    flucats_question_suspected_covid_871562009, 
    flucats_question_suspected_covid_906711000000107, 
    flucats_question_suspected_covid_906721000000101, 
    flucats_question_suspected_covid_933791000000101, 
    flucats_question_probable_covid_1240581000000104, 
    flucats_question_probable_covid_1300721000000109, 
    flucats_question_probable_covid_1300731000000106, 
    flucats_question_probable_covid_1321301000000101, 
    flucats_question_probable_covid_1322781000000102, 
    flucats_question_probable_covid_1324601000000106, 
    flucats_question_oxygen_saturation_1259025002, 
    flucats_question_oxygen_saturation_1363901000000105, 
    flucats_question_oxygen_saturation_149761000000108, 
    flucats_question_oxygen_saturation_162737002, 
    flucats_question_oxygen_saturation_162742005, 
    flucats_question_oxygen_saturation_182713008, 
    flucats_question_oxygen_saturation_182714002, 
    flucats_question_oxygen_saturation_201651000000108, 
    flucats_question_oxygen_saturation_201661000000106, 
    flucats_question_oxygen_saturation_240051000000102, 
    flucats_question_oxygen_saturation_243011000000108, 
    flucats_question_oxygen_saturation_243136002, 
    flucats_question_oxygen_saturation_243137006, 
    flucats_question_oxygen_saturation_243177003, 
    flucats_question_oxygen_saturation_243178008, 
    flucats_question_oxygen_saturation_250554003, 
    flucats_question_oxygen_saturation_252465000, 
    flucats_question_oxygen_saturation_252568001, 
    flucats_question_oxygen_saturation_276732005, 
    flucats_question_oxygen_saturation_276855002, 
    flucats_question_oxygen_saturation_304577004, 
    flucats_question_oxygen_saturation_315041000, 
    flucats_question_oxygen_saturation_371907003, 
    flucats_question_oxygen_saturation_371908008, 
    flucats_question_oxygen_saturation_391893003, 
    flucats_question_oxygen_saturation_397815001, 
    flucats_question_oxygen_saturation_397867002, 
    flucats_question_oxygen_saturation_397957008, 
    flucats_question_oxygen_saturation_398077001, 
    flucats_question_oxygen_saturation_398287006, 
    flucats_question_oxygen_saturation_426990007, 
    flucats_question_oxygen_saturation_427064004, 
    flucats_question_oxygen_saturation_429253002, 
    flucats_question_oxygen_saturation_57485005, 
    flucats_question_oxygen_saturation_699463009, 
    flucats_question_oxygen_saturation_71786000, 
    flucats_question_oxygen_saturation_788538002, 
    flucats_question_oxygen_saturation_802801000000109, 
    flucats_question_oxygen_saturation_861341000000108, 
    flucats_question_oxygen_saturation_870533002, 
    flucats_question_temperature_164300005, 
    flucats_question_temperature_164303007, 
    flucats_question_temperature_315632006, 
    ...
    flucats_question_numeric_value_oxygen_saturation_852651000000100_value, 
    flucats_question_numeric_value_oxygen_saturation_852651000000100, 
    flucats_question_numeric_value_oxygen_saturation_852661000000102_value, 
    ...
    flucats_question_numeric_value_oxygen_saturation_866721000000109_value, 
    ...
    flucats_question_causing_clinical_concern_162666005, 
    flucats_question_clinical_concern_note_37331000000100, 
    flucats_question_dehydration_or_shock_15527001, 
    flucats_question_dehydration_or_shock_162685008, 
    flucats_question_dehydration_or_shock_312450001, 
    flucats_question_dehydration_or_shock_787041000000101, 
    flucats_question_dehydration_or_shock_787051000000103, 
