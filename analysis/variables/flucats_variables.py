...
flucats_variables_163020007_numeric = loop_over_codes(
    numeric=True,
    question_str="blood_pressure",
    code_list=codelist(["163020007"], system="snomed"),
)
flucats_variables_15527001_numeric = loop_over_codes(
    numeric=True,
    question_str="dehydration_or_shock",
    code_list=codelist(["15527001"], system="snomed"),
)
flucats_variables_787041000000101_numeric = loop_over_codes(
    numeric=True,
    question_str="dehydration_or_shock",
    code_list=codelist(["787041000000101"], system="snomed"),
)
flucats_variables_787051000000103_numeric = loop_over_codes(
    numeric=True,
    question_str="dehydration_or_shock",
    code_list=codelist(["787051000000103"], system="snomed"),
)
flucats_variables_162986007_numeric = loop_over_codes(
    numeric=True,
    question_str="heart_rate",
    code_list=codelist(["162986007"], system="snomed"),
)
flucats_variables_162913005_numeric = loop_over_codes(
    numeric=True,
    question_str="respiratory_rate",
    code_list=codelist(["162913005"], system="snomed"),
)
