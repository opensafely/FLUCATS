...
df_1 = chunk_and_filter('output/joined/input_2020-04-01.csv.gz')
...
for file in files:
    ...
    df_2 = chunk_and_filter(f'output/joined/{file}')
...
df_1.to_csv('output/joined/input_all_py.csv.gz', index=False)
